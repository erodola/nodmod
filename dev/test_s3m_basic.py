...
def _build_s3m_header_bytes() -> bytes:
    ...
    header += struct.pack("<6H", 5, 2, 3, 0x0080, 0x1320, 2)
    header += b"SCRM"
    ...
    header += struct.pack("<2H", 0x0010, 0x0020)
...
def test_s3m_header_load_synthetic() -> None:
    ...
    try:
        ...
        assert_true(song.instrument_count == 2, "S3M synthetic instrument_count mismatch")
        ...
        assert_true(song.instrument_offsets == [0x100, 0x200], "S3M instrument offsets mismatch")
